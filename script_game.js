...
///////////////////////////////////////////////////////////////////////
  ...
  function resultsInfo() {
    ...
    const dataReceived = localStorage.getItem(dataPlayer.database);
    return JSON.parse(dataReceived);
  };

  const dataResult = resultsInfo();


  const dataResultValues = {

    resultX: dataResult ? dataResult.resultX : 0,
    resultO: dataResult ? dataResult.resultO : 0,
    resultTie: dataResult ? dataResult.resultTie : 0,
  };


  function setDefaultResultValues() {

    resX.innerHTML = dataResultValues.resultX;
    resO.innerHTML = dataResultValues.resultO;
    resTie.innerHTML = dataResultValues.resultTie; 
  };

  

  const storeDataValuesToLocalStorage = function() {

    const dataToSave = JSON.stringify(dataResultValues);
    localStorage.setItem(dataPlayer.database, dataToSave);
  };
  ...
  const setWinner = function(valArr) {
    ...
    if(valArr[0] === "x") {
       ...
       dataResultValues.resultX = resX.innerHTML;
       addLogoOnMessage("x");
       ...
       dataResultValues.resultO = resO.innerHTML;
       addLogoOnMessage("o");
  ...
  const setTie = function() {
    ...
    dataResultValues.resultTie = resTie.innerHTML;
    title.innerHTML = "";
    message.style.color = "#A8BFC9";
...
/////////////////////////////////////////////////////////////////////////
  ...
  restart.addEventListener("click", function(e){
    ...
    setRestartFeatures();
    localStorage.removeItem(dataPlayer.database);
  });
